...
class Copyright_Plugin implements Typecho_Plugin_Interface {
    ...
    private static function render($cr) {
        ...
        if ($cr['is_enable']) {
            ...
            $copyright_html = '<blockquote class="content-copyright" style="font-style:normal;font-size: 95%;border-left: 4px solid #ff8080;margin: 50px -15px 0 -15px;padding: 1px 20px 1px 20px;">' . $t_author . $t_url . $t_notice . '</blockquote>';
        }
